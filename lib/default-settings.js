          ...
          <apex:remoteObjects jsNamespace="<%= options.remoteObject.namespace %>">
            <% Object.keys(options.remoteObject.models).forEach(function (modelName) { %>
              <apex:remoteObjectModel
                name="<%=options.remoteObject.models[modelName].packageName ? options.remoteObject.models[modelName].packageName + '__' : '' %><%= modelName  %>"
                fields="<%= options.remoteObject.models[modelName].fields || options.remoteObject.models[modelName] %>"
              />
            <% }) %>
          </apex:remoteObjects >
        <% } %>
